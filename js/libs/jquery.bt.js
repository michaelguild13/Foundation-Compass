 ...
 * @author Corey Oordt - National Geographic Society (patch)
 * @version 0.9.5 release candidate 2  (12/2/2011)
 */
 
jQuery.bt = {version: '0.9.5-rc2'};
  ...
  jQuery.fn.bt = function(content, options) {
    ...
    return this.each(function(index) {
      ...
      this.btOn = function () {
        ...
        var $box = $('<div id="tooltip-content" class="bt-wrapper"></div>').append($text).addClass(opts.cssClass).css({position: 'absolute', width: opts.width, zIndex: opts.wrapperzIndex, visibility:'hidden'}).appendTo(offsetParent);
