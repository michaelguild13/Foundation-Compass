        ...
        accessibleTabs: function(config) {
            ...
            return this.each(function(t) {
                ...
                $(el).find(o.options.tabhead).each(function(i){
                    ...
                    var tabId = elId;//get a unique id to assign to this tab's heading
                    var navItemId = elId;//get a unique id for this navigation item
                    
                    //var tabId = o.getUniqueId('accessibletabscontent'+randomNumber, tabsCount+t, i);//get a unique id to assign to this tab's heading
                    //var navItemId = o.getUniqueId('accessibletabsnavigation'+randomNumber, tabsCount+t, i);//get a unique id for this navigation item
